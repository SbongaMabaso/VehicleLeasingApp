...
namespace VehicleLeasingApp.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SupplierId,Name,ContactPerson,Phone")] Suppliers suppliers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SupplierId,Name,ContactPerson,Phone")] Suppliers suppliers)
        {

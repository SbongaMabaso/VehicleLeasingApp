...
namespace VehicleLeasingApp.Controllers
{
    public class DriversController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            if (drivers == null)
            {
                TempData["Error"] = "Driver Detials Not Found";
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("DriverId,FullName,LicenseNumber,LicenseExpiry")] Drivers drivers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DriverId,FullName,LicenseNumber,LicenseExpiry")] Drivers drivers)
        {
            if (id != drivers.DriverId)
            {
                TempData["Error"] = "Driver ID Not Found";
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateConcurrencyException)
                {
                    ...
                    {
                        TempData["Error"] = "Diver Detials Not Found";
                        return NotFound();
                    }
                    else
                    {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (drivers != null)
            {
                ...
                TempData["Success"] = "Driver Deleted Successfuly";
            }
